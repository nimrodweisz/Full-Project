import { Grid, Paper, Input, Typography,Box, Button } from "@mui/material";
  ...
  return (
    <Grid>
      <Paper elevation={10} style={paperStyle}>
        ...
        <form action="post">
          <Grid container alignItems="center" justifyContent="flex-end"> {/* Use Grid container for alignment */}
            <Grid item xs={9}> 
